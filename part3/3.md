...
+
```
>>>'i am {},my age is {}'.format('python', 28)
'i am python,my age is 28'
```
+
```
>>>'i am {0},my age is {1}'.format('python', 28)
'i am python,my age is 28'
```

+
```
>>>'i am {name},my age is {age}'.format(name = 'python', age = 18)
'i am python,my age is 18'
```
